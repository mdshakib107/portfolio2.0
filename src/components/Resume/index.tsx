      ...
      <div className="container mx-auto">
        ...
        <div className="flex justify-center items-center ">
          <div className="grid grid-cols-2 gap-14 lg:gap-7">
              ...
              <div className="education-timeline">
                ...
                <div className="timeline-wrap">
                  <div className="timeline relative block items-start rounded-full border-white border-opacity-20 first:mt-0 md:flex">
                    ...
                    <div className="timeline-right relative border-l-4 border-white border-opacity-20 pt-16 pl-9 md:pt-6">
            ...
            <div className="col-span-2 lg:col-span-1 ml-12">
              <div className="job-experience">
                ...
                <div className="timeline-wrap">
                  <div className="timeline relative block items-start rounded-full border-white border-opacity-20 first:mt-0 md:flex">
                    ...
                    <div className="timeline-right relative border-l-3 border-white border-opacity-20 pt-16 pl-9 md:pt-6">
                      <h5 className="mb-0 text-teal-500">
